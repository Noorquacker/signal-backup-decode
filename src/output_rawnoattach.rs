...
/// directories, but skips attachments
pub struct SignalOutputRawNoAttach {
...
impl crate::output::SignalOutput for SignalOutputRawNoAttach {
	fn write_statement(
		&mut self,
		statement: &str,
